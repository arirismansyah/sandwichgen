...
<div class="content-wrapper">
      ...
      <div class="container justify-content-between align-items-center">
        ...
        >
          <div class="navbar-brand">
            <a href="./index.html">
              <img
                class="logo-dark"
                src="/assets_template/img/logo-dark.png"
                srcset="/assets_template/img/logo-dark@2x.png 2x"
                alt=""
              />
              <img
                class="logo-light"
                src="/assets_template/img/logo-light.png"
                srcset="/assets_template/img/logo-light@2x.png 2x"
                alt=""
              />
            </a>
          </div>
        ...
        >
          <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
            ...
            >
              <a href="./index.html" class="transition-none"
                ><img
                  class="logo-dark"
                  src="/assets_template/img/logo-dark.png"
                  srcset="/assets_template/img/logo-dark@2x.png 2x"
              ...
              <ul class="navbar-nav ms-lg-auto">
                      ...
                      >
                        <li class="col">
                          <a class="dropdown-item" href="./demo1.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi1.jpg"
                                srcset="/assets_template/img/demos/mi1@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo2.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi2.jpg"
                                srcset="/assets_template/img/demos/mi2@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo3.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi3.jpg"
                                srcset="/assets_template/img/demos/mi3@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo4.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi4.jpg"
                                srcset="/assets_template/img/demos/mi4@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo5.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi5.jpg"
                                srcset="/assets_template/img/demos/mi5@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo6.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi6.jpg"
                                srcset="/assets_template/img/demos/mi6@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo7.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi7.jpg"
                                srcset="/assets_template/img/demos/mi7@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo8.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi8.jpg"
                                srcset="/assets_template/img/demos/mi8@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo9.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi9.jpg"
                                srcset="/assets_template/img/demos/mi9@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo10.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi10.jpg"
                                srcset="/assets_template/img/demos/mi10@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo11.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi11.jpg"
                                srcset="/assets_template/img/demos/mi11@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo12.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi12.jpg"
                                srcset="/assets_template/img/demos/mi12@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo13.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi13.jpg"
                                srcset="/assets_template/img/demos/mi13@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo14.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi14.jpg"
                                srcset="/assets_template/img/demos/mi14@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo15.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi15.jpg"
                                srcset="/assets_template/img/demos/mi15@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo16.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi16.jpg"
                                srcset="/assets_template/img/demos/mi16@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo17.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi17.jpg"
                                srcset="/assets_template/img/demos/mi17@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo18.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi18.jpg"
                                srcset="/assets_template/img/demos/mi18@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo19.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi19.jpg"
                                srcset="/assets_template/img/demos/mi19@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo20.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi20.jpg"
                                srcset="/assets_template/img/demos/mi20@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                        ...
                        <li class="col">
                          <a class="dropdown-item" href="./demo21.html">
                            <figure class="rounded lift d-none d-lg-block">
                              <img
                                src="/assets_template/img/demos/mi21.jpg"
                                srcset="/assets_template/img/demos/mi21@2x.jpg 2x"
                                alt=""
                              />
                            </figure>
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="nav-item">
                      <a class="dropdown-item" href="./onepage.html">One Page</a
                      >
                    </li>
                  </ul>
                </li>
                      ...
                      <div>
                        ...
                        <ul class="list-unstyled">
                          <li>
                            <a
                              class="dropdown-item"
                              href="./single-project.html">Single Project I</a
                            >
                          </li>
                          <li>
                            <a
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block1.svg"
                                alt=""
                              />
                            </div>
                            <span>About</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block2.svg"
                                alt=""
                              />
                            </div>
                            <span>Blog</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block3.svg"
                                alt=""
                              />
                            </div>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block4.svg"
                                alt=""
                              />
                            </div>
                            <span>Clients</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block5.svg"
                                alt=""
                              />
                            </div>
                            <span>Contact</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block6.svg"
                                alt=""
                              />
                            </div>
                            <span>Facts</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block7.svg"
                                alt=""
                              />
                            </div>
                            <span>FAQ</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block8.svg"
                                alt=""
                              />
                            </div>
                            <span>Features</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block9.svg"
                                alt=""
                              />
                            </div>
                            <span>Footer</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block10.svg"
                                alt=""
                              />
                            </div>
                            <span>Hero</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block17.svg"
                                alt=""
                              />
                            </div>
                            <span>Misc</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block11.svg"
                                alt=""
                              />
                            </div>
                            <span>Navbar</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block12.svg"
                                alt=""
                              />
                            </div>
                            <span>Portfolio</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block13.svg"
                                alt=""
                              />
                            </div>
                            <span>Pricing</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block14.svg"
                                alt=""
                              />
                            </div>
                            <span>Process</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block15.svg"
                                alt=""
                              />
                            </div>
                            <span>Team</span>
                        ...
                        <li class="col">
                          ...
                          >
                            ...
                            >
                              <img
                                class="rounded-0"
                                src="/assets_template/img/demos/block16.svg"
                                alt=""
                              />
                            </div>
                        ...
                        <div class="col-lg-8">
                          ...
                          <ul class="list-unstyled cc-3">
                            ...
                            <li>
                              <a
                                class="dropdown-item"
                                href="./docs/elements/alerts.html">Alerts</a
                              >
                            </li>
                            <li>
                              <a
                            ...
                            <li>
                              <a
                                class="dropdown-item"
                                href="./docs/elements/badges.html">Badges</a
                              >
                            </li>
                            <li>
                              <a
                                class="dropdown-item"
                                href="./docs/elements/breadcrumb.html"
                                >Breadcrumb</a
                              >
                            </li>
                            <li>
                            ...
                            <li>
                              <a
                                class="dropdown-item"
                                href="./docs/elements/card.html">Card</a
                              >
                            </li>
                            <li>
                              <a
                            ...
                            <li>
                              <a
                                class="dropdown-item"
                                href="./docs/elements/modal.html">Modal</a
                              >
                            </li>
                            <li>
                              <a
                            ...
                            <li>
                              <a
                                class="dropdown-item"
                                href="./docs/elements/shapes.html">Shapes</a
                              >
                            </li>
                            <li>
                              <a
                                class="dropdown-item"
                                href="./docs/elements/tables.html">Tables</a
                              >
                            </li>
                            <li>
                              <a
                                class="dropdown-item"
                                href="./docs/elements/tabs.html">Tabs</a
                              >
                            </li>
                            <li>
                              <a
                            ...
                            <li>
                              <a
                                class="dropdown-item"
                                href="./docs/elements/tiles.html">Tiles</a
                              >
                            </li>
                            <li>
                              <a
  ...
  <section
    ...
    data-image-src="/assets_template/img/photos/bg16.png"
  >
      ...
      <div class="row">
        ...
        >
          <h1 class="display-1 text-white fs-60 mb-4 px-md-15 px-lg-0">
            We bring solutions to make life <span
              class="underline-3 style-2 yellow">easier</span
            >
          </h1>
      ...
      <div class="row gx-md-5 gy-5 mt-n19 mb-14 mb-md-17">
        <div class="col-md-6 col-xl-3">
          <div class="card shadow-lg">
            <div class="card-body">
              <img
                src="/assets_template/img/icons/solid/edit.svg"
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card shadow-lg">
            <div class="card-body">
              <img
                src="/assets_template/img/icons/solid/team.svg"
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card shadow-lg">
            <div class="card-body">
              <img
                src="/assets_template/img/icons/solid/lamp.svg"
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card shadow-lg">
            <div class="card-body">
              <img
                src="/assets_template/img/icons/solid/delivery-box.svg"
      ...
      <div class="row">
        ...
        >
          ...
          <h3 class="display-3 mb-10 px-xl-10 px-xxl-15">
            Here are a few <span class="underline-3 style-2 yellow"
              >reasons</span
      ...
      >
        <li class="nav-item">
          ...
          >
            <div>
              <img
                src="/assets_template/img/icons/solid/bulb.svg"
        ...
        <li class="nav-item">
          ...
          >
            <div>
              <img
                src="/assets_template/img/icons/solid/compare.svg"
        ...
        <li class="nav-item">
          ...
          >
            <div>
              <img
                src="/assets_template/img/icons/solid/delivery-box.svg"
                class="svg-inject icon-svg icon-svg-sm solid-mono text-green me-4"
                alt=""
              />
            </div>
            <div>
          ...
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-lg-6">
              <figure class="rounded shadow-lg">
                <img
                  src="/assets_template/img/photos/se5.jpg"
                  srcset="/assets_template/img/photos/se5@2x.jpg 2x"
                  alt=""
                />
              </figure>
            </div>
            ...
            <div class="col-lg-6">
              ...
              <ul class="icon-list bullet-bg bullet-soft-fuchsia">
                <li>
                  <i class="uil uil-check" />Aenean eu leo quam. Pellentesque
                  ornare.
                </li>
                <li>
                  <i class="uil uil-check" />Nullam quis risus eget urna mollis
                  ornare.
                </li>
                <li>
                  <i class="uil uil-check" />Donec id elit non mi porta gravida
                  at eget.
                </li>
              </ul>
        ...
        <div class="tab-pane fade" id="tab2-2">
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-lg-6 order-lg-2">
              <figure class="rounded shadow-lg">
                <img
                  src="/assets_template/img/photos/se6.jpg"
                  srcset="/assets_template/img/photos/se6@2x.jpg 2x"
                  alt=""
                />
              </figure>
            </div>
        ...
        <div class="tab-pane fade" id="tab2-3">
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-lg-6">
              <figure class="rounded shadow-lg">
                <img
                  src="/assets_template/img/photos/se7.jpg"
                  srcset="/assets_template/img/photos/se7@2x.jpg 2x"
                  alt=""
                />
              </figure>
            </div>
      ...
      <div class="row align-items-center gy-8 mb-13">
        <div class="col-lg-7 text-center text-lg-start">
          ...
          <h3 class="display-3 mb-0 pe-xl-10 pe-xxl-15">
            Save your time and money by choosing our <span
              class="underline-3 style-2 yellow">professional</span
            > team.
          </h3>
        </div>
        <!-- /column -->
        <div class="col-lg-5">
          <div class="row gy-6 text-center">
            <div class="col-md-6">
              <div class="progressbar semi-circle fuchsia" data-value="95" />
              <h4 class="mb-0">Customer Satisfaction</h4>
            </div>
            <!-- /column -->
            <div class="col-md-6">
              <div class="progressbar semi-circle orange" data-value="80" />
  ...
  <section class="wrapper bg-light">
    <div class="container py-16 py-md-18">
      <div class="card shadow-lg mt-n21 mt-md-n23">
        <div class="row gx-0">
          <div
            ...
            data-image-src="/assets_template/img/photos/tm2.jpg"
          />
          <!--/column -->
          <div class="col-lg-6">
                ...
                <div class="swiper">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide text-center">
                      <span class="ratings five mt-4 mb-3" />
      ...
      <div class="row mt-17">
        <div class="col-lg-10 col-xl-9 col-xxl-8 mx-auto text-center">
          ...
          <h3 class="display-3 mb-10">
            Check out some of our awesome projects with <span
              class="underline-3 style-2 yellow">creative</span
      ...
      <!-- /.row -->
      <div
        class="swiper-container grid-view"
        data-margin="30"
        data-dots="true"
        data-items-xl="3"
        data-items-md="2"
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <figure class="rounded mb-6">
                <img
                  src="/assets_template/img/photos/pd7.jpg"
                  srcset="/assets_template/img/photos/pd7@2x.jpg 2x"
                  alt=""
                /><a
                  class="item-link"
                  href="/assets_template/img/photos/pd7-full.jpg"
                  data-glightbox
                  data-gallery="projects-group"
                  ><i class="uil uil-focus-add" /></a
                >
              </figure>
              <div
            ...
            <div class="swiper-slide">
              <figure class="rounded mb-6">
                <img
                  src="/assets_template/img/photos/pd8.jpg"
                  srcset="/assets_template/img/photos/pd8@2x.jpg 2x"
                  alt=""
                /><a
                  class="item-link"
                  href="/assets_template/img/photos/pd8-full.jpg"
                  data-glightbox
                  data-gallery="projects-group"
                  ><i class="uil uil-focus-add" /></a
                >
              ...
              >
                <div class="post-header">
                  <h2 class="post-title h3">
                    <a href="./single-project2.html" class="link-dark"
            ...
            <div class="swiper-slide">
              <figure class="rounded mb-6">
                <img
                  src="/assets_template/img/photos/pd9.jpg"
                  srcset="/assets_template/img/photos/pd9@2x.jpg 2x"
                  alt=""
                /><a
                  class="item-link"
                  href="/assets_template/img/photos/pd9-full.jpg"
                  data-glightbox
                  data-gallery="projects-group"
                  ><i class="uil uil-focus-add" /></a
                >
              ...
              >
                <div class="post-header">
                  <h2 class="post-title h3">
                    <a href="./single-project3.html" class="link-dark"
            ...
            <div class="swiper-slide">
              <figure class="rounded mb-6">
                <img
                  src="/assets_template/img/photos/pd10.jpg"
                  srcset="/assets_template/img/photos/pd10@2x.jpg 2x"
                  alt=""
                /><a
                  class="item-link"
                  href="/assets_template/img/photos/pd10-full.jpg"
                  data-glightbox
                  data-gallery="projects-group"
                  ><i class="uil uil-focus-add" /></a
                >
            ...
            <div class="swiper-slide">
              <figure class="rounded mb-6">
                <img
                  src="/assets_template/img/photos/pd11.jpg"
                  srcset="/assets_template/img/photos/pd11@2x.jpg 2x"
                  alt=""
                /><a
                  class="item-link"
                  href="/assets_template/img/photos/pd11-full.jpg"
                  data-glightbox
                  data-gallery="projects-group"
                  ><i class="uil uil-focus-add" /></a
                >
            ...
            <div class="swiper-slide">
              <figure class="rounded mb-6">
                <img
                  src="/assets_template/img/photos/pd12.jpg"
                  srcset="/assets_template/img/photos/pd12@2x.jpg 2x"
                  alt=""
                /><a
                  class="item-link"
                  href="/assets_template/img/photos/pd12-full.jpg"
                  data-glightbox
                  data-gallery="projects-group"
                  ><i class="uil uil-focus-add" /></a
                >
          ...
          <div class="row gx-md-5 gy-5">
            <div class="col-12">
              <figure class="rounded mx-md-5">
                <img
                  src="/assets_template/img/photos/g8.jpg"
                  srcset="/assets_template/img/photos/g8@2x.jpg 2x"
                  alt=""
                />
              </figure>
            </div>
            ...
            <div class="col-md-6">
              <figure class="rounded">
                <img
                  src="/assets_template/img/photos/g9.jpg"
                  srcset="/assets_template/img/photos/g9@2x.jpg 2x"
                  alt=""
                />
              </figure>
            </div>
            ...
            <div class="col-md-6">
              <figure class="rounded">
                <img
                  src="/assets_template/img/photos/g10.jpg"
                  srcset="/assets_template/img/photos/g10@2x.jpg 2x"
                  alt=""
                />
              </figure>
            </div>
          ...
          <div class="row gy-6">
            ...
            <div class="col-md-6">
              <div class="d-flex flex-row">
                <div>
                  <img
                    src="/assets_template/img/icons/solid/puzzle.svg"
            ...
            <div class="col-md-6">
              <div class="d-flex flex-row">
                <div>
                  <img
                    src="/assets_template/img/icons/solid/headphone.svg"
        ...
        <div class="row text-center">
          <div class="col-xl-11 col-xxl-9 mx-auto">
            ...
            <h3 class="display-3 mb-8 px-lg-8 text-white">
              We are <span class="underline-3 style-2 yellow">trusted</span> by over
    ...
    <div class="row gy-6 gy-lg-0">
      <div class="col-md-4 col-lg-3">
        <div class="widget">
          ...
          />
          <p class="mb-4">
            © 2021 Sandbox. <br class="d-none d-lg-block" />All rights reserved.
          </p>
      ...
      <div class="col-md-4 col-lg-3">
        <div class="widget">
          ...
          <a href="mailto:#" class="link-body">info@email.com</a><br /> 00 (123)
          456 78 90
        </div>
        <!-- /.widget -->
      </div>
