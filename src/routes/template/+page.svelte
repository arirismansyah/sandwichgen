          ...
          <div class="card-body py-14 px-0">
            <div class="container">
              <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center text-center text-lg-start">
                ...
                <!--/column -->
                <div class="col-lg-6">
                  <img class="img-fluid mb-n18" src="./../assets_template/images/illustrations/3d6.png" srcset="/assets_template/images/illustrations/3d6@2x.png 2x" data-cue="fadeIn" data-delay="300" alt="" />
                </div>
                <!--/column -->
              </div>
              <!-- /.row -->
