...
<div class="wrapper">
  ...
  <section>
    <div class="content d-flex align-items-center">
      <Saos animation={"from-left 1s cubic-bezier(0.35, 0.5, 0.65, 0.95) both"}>
        <div class="row m-4">
          <div class="col-md-12">
            <h2 class="fs-32 mb-3">Lantas</h2>
            <h2 class="display-3 mb-10 style-2 yellow">
              Apa itu <span class="underline-3 style-2 yellow"
                >Sandwich Generation?</span
              >
            </h2>
          </div>
          <!-- /column -->
  ...
  <section>
    <div class="content d-flex align-items-center">
      <Saos animation={"from-left 1s cubic-bezier(0.35, 0.5, 0.65, 0.95) both"}>
        <div class="row m-4">
          <div class="col-md-12">
            <h2 class="fs-32 mb-3">Mengapa</h2>
            <h2 class="display-3 mb-10 style-2 yellow">
              disebut <span class="underline-3 style-2 yellow"
                >Sandwich Generation?</span
              >
            </h2>
          </div>
  ...
  <section>
    ...
    <div class="content d-flex align-items-center">
      <div class="row m-4">
        <div class="col-md-12">
          <h2 class="fs-32 mb-3 slide-top">dan bagaimana</h2>
          <h2 class="display-3 style-2 yellow slide-top">
            Bhaskara <span class="underline-3 style-2 yellow">mampu keluar</span
            >
          </h2>
          <p class="fs-24">dari jerat ekonomi yang begitu sulit?</p>
        </div>
        <!-- /column -->
      </div>
    </div>
